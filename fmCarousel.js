...
{ 
    ...
    function initialize () {
     ...
     $.fn.fmDrawCarrucel = function(params) {
            var options = $.extend({}, $.fmdc.carousel.options, params);
            this.each(function (){$(this).data('fmdc', new Carousel($(this), options)); });
            return this;
        };
        
    $.fn.fmDrawCarrucelRefresh = function () { 
        $(this).data('fmdc').refreshDesign(); 
    };
    /*

    */
    $.fn.fmDrawCarrucelMoveToLeft = function (numberOfSlides) { 
        $(this).data('fmdc').MoveToLeft(numberOfSlides);
    }; 

    $.fn.setCallBackAfterMove = function (callback) { 
        $(this).data('fmdc').setCallBackAfterMove(callback); 
    };
    
    $.fn.fmDrawCarrucelUpdate = function () { 
        $(this).data('fmdc').arrows(); 
    };
